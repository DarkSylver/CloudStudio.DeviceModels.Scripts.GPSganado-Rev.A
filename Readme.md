...
# Configuration Script – GPS ganado - Rev. A

This **Configuration** script is designed for the **GPS ganado** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – GPS ganado Rev. A

Este script de **Configuration** está diseñado para el modelo **GPS ganado** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
